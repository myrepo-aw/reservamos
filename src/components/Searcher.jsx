...
function Searcher() {
  ...
  useEffect(() => {
    const fetchWeather = async () => {
      if (cityLat && cityLong) {
        try {
          const response = await fetchDataWeather(); // Fetch data
          setWeather(response.data); // Set weather state with response.data
          console.log(weather);
        } catch (error) {
        ...
        {weather && (
          <div className="row mt-5 d-flex justify-content-center text-center pt-5">
            <div className="col-12 mt-5">
              <div className='searcher--days-container d-inline-block'>
                <h2 className='searcher--days-container--title'>Día 1</h2>
                <strong className='searcher--days-container--text mt-2 d-inline-block'>{weather.list[0].main.temp}</strong>
              </div>

              <div className='searcher--days-container d-inline-block ms-5'>
                <h2 className='searcher--days-container--title'>Día 2</h2>
                <strong className='searcher--days-container--text mt-2 d-inline-block'>{weather.list[1].main.temp}</strong>
              </div>

              <div className='searcher--days-container d-inline-block ms-5'>
                <h2 className='searcher--days-container--title'>Día 3</h2>
                <strong className='searcher--days-container--text mt-2 d-inline-block'>{weather.list[2].main.temp}</strong>
              </div>

              <div className='searcher--days-container d-inline-block ms-5'>
                <h2 className='searcher--days-container--title'>Día 4</h2>
                <strong className='searcher--days-container--text mt-2 d-inline-block'>{weather.list[3].main.temp}</strong>
              </div>

              <div className='searcher--days-container d-inline-block ms-5'>
                <h2 className='searcher--days-container--title'>Día 5</h2>
                <strong className='searcher--days-container--text mt-2 d-inline-block'>{weather.list[4].main.temp}</strong>
              </div>
            </div>
          </div>
        )}
